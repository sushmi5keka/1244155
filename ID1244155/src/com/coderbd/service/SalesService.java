...
public class SalesService {
    ...
    public static void createTable() {
        String sql = "create table sales(id int auto_increment primary key, productName varchar(30) not null, productCode varchar(30) not null,qty int(11) not null,unitprice double not null,  totalPrice double not null, salesdate Date not null, product_id int(11) not null,user_id int(11) not null, foreign key (product_id) references purchase(id),foreign key (user_id) references user(id))";
        try {
